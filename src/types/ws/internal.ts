...
import { chats, deleteChat, dlvrd, newChat, newCall, nw, read, typing, closeCall } from './event-literals'
...
export type InternalEventType = nw | chats | typing | read | dlvrd | newChat | deleteChat | newCall | closeCall
